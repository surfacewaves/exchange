package ru.andreev.exchange.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        .requestMatchers("/v1/rates/latest").permitAll()
                        .requestMatchers("/v1/rates/historical").hasRole("EXCHANGE-USER")
                        .requestMatchers("/v1/rates/count-total").permitAll()
                        .anyRequest().denyAll())
